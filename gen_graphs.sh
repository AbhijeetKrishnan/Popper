...
python3 tactics/generate_graphs.py tactics/data/stats/metrics_test_t_sf.csv -m avg_tactic_ground_avg -o tactics/data/graphs/divergence_t_sf.png --title "Divergence \$(T,\$ Stockfish 15, \$P_{test})\$" --xlabel "Divergence (Cp)" --left=-10
